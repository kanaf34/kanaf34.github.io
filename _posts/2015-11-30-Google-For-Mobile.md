...
> 
#### 요약
- 안드로이드에 관한 전반적인 설명과 구글플레이에 관한 전반적인 설명.
- 안드로이드 시장은 앞으로 더 성장할거에요, 우리 함께 으쌰으쌰해서 좋은 컨텐츠를 만들어요:) 라는 얘기였던 것 같아요.
...
###  이 모든 안드로이드에 컨텐츠를 전달하는 장소, 구글 플레이
...
- 구글IO 에서 발표한 것 소개
  1. 천과 전도성 물질을 결합하여 옷에서 폰을 꺼내지 않아도 음악을 넘기도록 하는..리바이스랑 협업헤서 청바지에 적용중.
  2. Project Soli (https://www.google.com/atap/project-soli/)
  3. Project Loon (https://www.google.com/loon/)
  4. 카드보드 (https://www.google.com/get/cardboard/)
...
- 구글의 성공은 뒤에 있는 인프라 덕이라고 하시네요.

 클라우드 1세대 : 다른 회사에서 서버 사기
 클라우드 2세대 : 클릭/ API 하나로 Virtual 머신를 이용하기
 클라우드 3세대 : 개발자들이 더이상 머신(기계)를 생각하지 않고 일을 진행.
                  그 위의 레벨에서 인프라가 알아서 관리해주는 세대가 되어야한다고 보시더라구요.


- Pop 이 존재, 구글이 직접 돈을 들여 구축한..
- 성능이 좋아져요. 보안이 강화되어요.

- 논문으로서 세상에 기여했던 구글이지만, 이제는 상품으로

- 평균 20,30초 내에서 버추얼머신 작동해요.
- 구글은 분당 과금입니다.
- 켜놓고 오래오래 두고 쓰면 할인해줘요.
- 구글이 이렇게 대단해요. 
 
### 2:00-3:00 장현세, 장태익 '게임 개발을 위한 구글 기술들과 그 미래'

 - 모바일 시장이 커지기 전에는 크롬에 투자했어요.
- 요즘은 안드로이드 시장에 좀 더 투자중이에요.

- 안드로이드 원 & 키노트 얘기 Repeat

- 4명 중 3명은 게임을 합니다. -> 플레이측에서도 게임 서비스를 주력으로 하나봐요.
- 성장 추이를 놓치지않기 위해 안드로이드 티비도 주목하고 있는가봅니다.
- 제대로 활성화가 되는가? 라고 하면 미약하다고 하네요.
- 엘지유플러스랑 뭔가 진행중인가봐요


- 빠른 시간에 개발해서 퍼트리는 경우에 유리?
- 구글플레이의 게임 서비스는 대형 게임사보다 스타트업에게 필요하다고 강조.
(대형 게임사에서는 이미 구축해놓아서..)
